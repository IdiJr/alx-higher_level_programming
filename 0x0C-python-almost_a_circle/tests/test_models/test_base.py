#!/usr/bin/python3
"""Defines unittest for base.py module"""
...
class Testbase_instances(unittest.TestCase):
    """Represents class for testing instances for base"""
...
class Testbase_to_json(unittest.TestCase):
    """Represents class for testing to_json functions"""
...
class Testbase_from_json(unittest.TestCase):
    """Represents class unittest for from_json_string method"""
...
class Testbase_save_file(unittest.TestCase):
    """Represents class unittest for save_to_file method"""
...
class Testbase_load_file(unittest.TestCase):
    """Represents class unittest for load_to_file method"""
...
class Testbase_create(unittest.TestCase):
    """Represents class unittest for create method"""
